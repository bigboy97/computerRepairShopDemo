...
<head>
    ...
    <title>Fast Repairs | Contact Us</title>
                  ...
                  Fast Repairs LLC
                    ...
                    Testimonials</a>
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="#contact"><i class="fa fa-envelope-open" aria-hidden="true"></i>Contact Us</a>
                            </li>
<?php
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="card">
                    <form class="form-horizontal" action="#" method="get">
                        <fieldset>
                            <legend class="text-center pt-4">Contact us</legend>
                            <hr>
                            <!-- Name input-->
